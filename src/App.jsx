      ...
      <section className="mx-auto flex min-h-screen max-w-7xl items-center px-6 py-20">
        <div className="max-w-4xl">
          ...
          <h1 className="max-w-4xl text-5xl font-bold tracking-tight md:text-7xl">
            AI as a <span className="text-indigo-400">Tutor</span>
            {" or a "}
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <button className="rounded-xl bg-indigo-500 px-6 py-3 font-semibold transition hover:bg-indigo-400">
              Start Research Assessment
            </button>

            <button className="rounded-xl border border-slate-700 px-6 py-3 font-semibold text-slate-200 transition hover:bg-slate-800">
...
function Feature({ icon, title, text }) {
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5">
      <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-slate-800 text-indigo-300">
        {icon}
      </div>
